...
function services() {
    ...
    <div id="services">
        <div id="services-content"> 
            ...
            <p id="services-text">Soy Samuel Torres, profesor, entrenador personal y especialista en movimiento y 
        ...
        <img id="services-img" src="https://www.carroceriasaviles.es/cache~b-e-3-6-5-be3657ae3eb9c96d2400484d6dde99d616e5ac52/big-foto-188965.jpg" className="services-img" alt='logo'></img>
    </div>
    );
}
